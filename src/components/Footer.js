...
export default function Footer() {
  return (
    <footer className="px-4 sm:px-6 lg:px-8 pb-6 sm:pb-10">
          ...
          <div className="flex gap-2 sm:gap-3">
            {social.map(({ Icon, label }) => (
              <motion.a
                ...
                whileTap={{ scale: 0.94 }}
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-border grid place-items-center text-ink hover:bg-chip hover:text-white hover:border-chip transition"
              >
      ...
      <Reveal variants={fadeIn} className="mx-auto max-w-7xl mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-ink-soft">
