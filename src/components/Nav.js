...
//       animate={{ y: 0, opacity: 1 }}
//       transition={{ duration: 0.8, ease: EASE, delay: 0.1 }}
//       className="fixed top-0 inset-x-0 z-50 px-3 sm:px-6 lg:px-8 pt-3 sm:pt-5 backdrop-blur-sm"
//     >
//       <div className="mx-auto max-w-7xl flex items-center justify-between gap-2 sm:gap-4">
//         {/* Logo – always visible */}
//         <motion.div
...
//           {/* Full "Get started" on tablet+, icon-only on mobile */}
//           <motion.a
//             href="#contact"
//             whileHover={{ scale: 1.04 }}
//             whileTap={{ scale: 0.96 }}
//             className="flex items-center gap-2 text-sm font-medium text-ink hover:bg-white/30 transition group rounded-full pl-4 pr-2 py-1.5 sm:flex hidden"
//           >
//             Get started
//             <span className="grid place-items-center w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-ink text-white overflow-hidden">
//               <motion.span
//                 initial={false}
//                 whileHover={{ rotate: 45 }}
//                 className="grid place-items-center"
...
//           {/* Mobile CTA – icon only (no text) */}
//           <motion.a
//             href="#contact"
//             whileHover={{ scale: 1.04 }}
//             whileTap={{ scale: 0.96 }}
//             className="sm:hidden flex items-center justify-center w-8 h-8 rounded-full text-ink hover:bg-white/30 transition"
