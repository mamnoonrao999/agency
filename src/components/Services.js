        ...
        <Stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6" stagger={0.08}>
          {services.map((s) => (
            <StaggerItem key={s.n} hover variants={scaleIn}>
              <div className="glass-card rounded-3xl p-6 sm:p-8 group h-full hover:bg-white/55 transition duration-300">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-ink tracking-tight mb-2 sm:mb-3">
                  {s.t}
                </h3>
