...
const works = [
  { img: '/work-1.png', t: 'holovox.io', tag: 'Your Conference Call Assistant', link: 'https://holovox.io/' },
  { img: '/work-6.png', t: 'lumiere.one', tag: 'Find Your Person', link: 'https://lumiere-one-lac.vercel.app/' },
  { img: '/work-3.png', t: 'hashfor.com', tag: 'AI Visibilty Engine', link: 'https://hashfor-8c2a.vercel.app/' },
  { img: '/work-4.png', t: 'cortex.ai', tag: 'Your Business Web Assistant', link: 'https://cortex-jade-pi.vercel.app/' },
  { img: '/work-2.png', t: 'deep-trace.com', tag: 'AI Content Detection', link: 'https://deep-trace-snowy.vercel.app/' },
  { img: '/work-5.png', t: 'cybercity.io', tag: 'Secure Your Business', link: 'https://vulnerability-dun.vercel.app/' },
];
  ...
  return (
    <section id="portfolio" className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <Stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-5 lg:gap-6" stagger={0.1}>
          {works.map((w) => (
            <StaggerItem key={w.t} hover variants={scaleIn}>
              <a
                href={w.link}
              ...
              >
                ...
                <div className="flex items-end justify-between p-2 pt-3">
                  <div>
                    <h3 className="font-bold text-ink tracking-tight">{w.t}</h3>
