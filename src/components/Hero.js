      ...
      <div className="flex flex-1 items-center justify-center pb-12 sm:pb-16 lg:pb-20 xl:pb-24">
        <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 lg:pt-40">
          ...
          <div className="max-w-4xl mx-auto sm:mx-0">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-serif font-normal tracking-[-0.03em] text-ink leading-[1.05]">
              <motion.span
                initial="hidden"
                animate="show"
...
//   return (
//     <section id="top" className="relative flex flex-col sm:min-h-screen">
//       <div className="flex sm:flex-1 items-start justify-center pb-24 sm:pb-16 lg:pb-0 xl:pb-0 2xl:pb-0">
//         <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 lg:pt-40 md:pb-16 sm:pb-12 lg:pb-20 xl:pb-20">
//           {/* Badge – smaller on mobile */}
//           <div className="flex justify-center pb-8 sm:pb-12 lg:pb-20 xl:pb-10 pt-20 sm:pt-12 md:pt-12 lg:pt-20 xl:pt-10">
//             <motion.div
//               initial={{ opacity: 0, y: 16 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: 0.2, duration: 0.6, ease: EASE }}
...
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ delay: 1.0, duration: 0.6, ease: EASE }}
//         className="w-full border-t border-ink/5 py-3 sm:py-6 overflow-hidden mt-8 sm:mt-0"
//       >
//         <motion.div
