...
function AuditContent() {
  ...
  const donutColor = scoreColor(overallScore);
  ...
  const getRadarData = (page) => {
    ...
    const metrics = {
      ...
      'H1 Count': Math.min(100, ((page.h1_count || 0) / 3) * 100),
      'H2 Count': Math.min(100, ((page.h2_count || 0) / 20) * 100),
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="relative w-[160px] h-[160px] mx-auto mt-2">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    ...
                    animationBegin={300}
                  >
                    <Cell key="score" fill={donutColor} />
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="text-center">
                  ...
                  <div className="text-xs text-ink-soft">Combined</div>
                </div>
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard className="text-center">
            ...
            <div className="mt-4">
              ...
              <div className="text-sm text-ink-soft mt-1">Search Engine Optimization</div>
            </div>
          ...
          <GlassCard className="text-center">
            ...
            <div className="mt-4">
              ...
              <div className="text-sm text-ink-soft mt-1">AI Search Optimization</div>
            </div>
            <div className="mt-3 flex flex-wrap justify-center gap-2">
            ...
            <GlassCard>
              ...
              <div className="max-h-72 overflow-y-auto pr-2 space-y-2">
                ...
                {allStrengths.map((s, idx) => (
                  <div key={idx} className="glass-pill rounded-xl p-3 border border-ink/5">
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                <div className="lg:w-1/2 flex-shrink-0">
                  <div className="relative w-full h-[340px] md:h-[400px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <RadarChart
                        key={currentPageIndex} // 🔥 forces re‑render on page change
                        cx="50%"
                        cy="50%"
                        outerRadius="80%"
                ...
                <div className="lg:w-1/2 flex flex-col max-h-[450px] overflow-y-auto pr-2 space-y-3">
...
//   // ─── Global strengths & issues (site‑wide) ────────
//   const allStrengths = [...seoStrengths, ...aiStrengths];
//   const allIssues = [...seoFaults, ...aiIssues];

//   // ─── Page‑specific strengths & issues ─────────────
//   const getPageStrengths = (pageUrl) => {
//     return allStrengths.filter(s => s.page && s.page.includes(pageUrl));
//   };
//   const getPageIssues = (pageUrl) => {
...
//       animate={{ opacity: 1 }}
//       transition={{ duration: 0.8, ease: EASE, delay: 0.2 }}
//       className="min-h-screen bg-[#f7f3ee] py-8 md:py-12 px-4 sm:px-6 lg:px-8"
//     >
//       <div className="max-w-[1400px] mx-auto">
...
//               {/* Two‑column layout: Radar + Details */}
//               <div className="flex flex-col lg:flex-row gap-6">
//                 {/* Left: Big Radar */}
//                 <div className="lg:w-1/2 flex-shrink-0">
//                   <div className="relative w-full h-[340px] md:h-[400px]">
...
//                 {/* Right: Detailed Description with per‑page strengths/issues */}
//                 <div className="lg:w-1/2 flex flex-col max-h-[450px] overflow-y-auto pr-2 space-y-3">
//                   <h4 className="text-xl font-bold text-ink truncate">{currentPage.title || currentPage.url}</h4>
//                   <div className="text-xs text-ink-soft truncate">{currentPage.url}</div>
